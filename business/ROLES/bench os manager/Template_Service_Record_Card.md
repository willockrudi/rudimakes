...
## MINI STICKER *(for pedals, small gear)*
...
- When it was done
- What tubes/parts are in it and how old they are
- Whether bias was set and to what
- Whether it's a repeat failure
- Whether the customer is within warranty
- Whether caps/tubes have already been done

This saves significant diagnosis time on every return visit.

---

## BENCH TECH AI INSTRUCTION

When Rudi says **"Create Service Record Card"** or **"Create job card"**:

Fill out the standard card template using all information from the current conversation. Keep SERVICE PERFORMED to 2–4 lines max. Keep PARTS REPLACED to a clean list. Keep NOTES to things a future tech actually needs. The whole card should fit on a half-sheet of cardstock or a large label.
